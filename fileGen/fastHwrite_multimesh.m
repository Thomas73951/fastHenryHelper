...
##EXT_FOLDER = ["CoilC", filesep];
##EXT_FOLDER = ['CoilC', filesep, 'z0.1', filesep];
...
a = linspace(0, 40, 41);
zval = [12 14 16];
for zPoint = 1:columns(zval)
  EXT_FOLDER = ['CoilA', filesep, 'z', num2str(zval(zPoint)), filesep];
