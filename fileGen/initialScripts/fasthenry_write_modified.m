...
file_name = 'fasthenry_matlab2.inp';
file = fopen(file_name,'wt');

fprintf(file, '* matlab-generated fasthenry file \n');
fprintf(file, '.units mm \n');
fprintf(file, '.default z = 0 sigma = 5.8e4 w = 0.5 h = 0.035 \n');
...
fprintf(file, 'E1 N1 N2 \n');
fprintf(file, 'E2 N2 N3 \n');
fprintf(file, 'E3 N3 N4 \n');
fprintf(file, 'E4 N4 N5 \n');
